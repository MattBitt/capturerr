...
async def login_user(
    ...
    potential_user: UserReadModel = user_query_usecase.login_user(user)
    
    token = create_access_token(potential_user.model_dump())
    potential_user.access_token = token
    logger.debug("potential_user", potential_user.user_name)
